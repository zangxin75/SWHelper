    ...
    public class SWHelper : ISWHelper
    {
        ...
        public bool CreateChamfer(double distance, double angle)
        {
            try
            {
                ...
                if (feature == null)
                {
                    lastError = $"无法创建倒角特征，距离: {distance}, 角度: {angle}";
                    return false;
                }
        ...
        public bool CreateShell(double thickness)
        {
            try
            {
                ...
                if (feature == null)
                {
                    lastError = $"无法创建抽壳特征，厚度: {thickness}";
                    return false;
                }
